...
# Feature: test graphql end point
  ...
  # Scenario Outline: graphql from a file and variables
    ...
    # When method post
    # Then match $.data.pokemon.evolutions[0].name == '<evoName>'
    # And match $.data.pokemon.evolutions[0].number == '<evoNumber>'
    # And match $.data.pokemon.evolutions[0].attacks.fast == '#[2]'

    # Examples:
    # | name | evoName   | evoNumber  |
    # | Pikachu | Raichu   | 026      |
    # | Meowth  | Persian  | 053      |
